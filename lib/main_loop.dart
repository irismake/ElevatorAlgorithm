...
void main() {
  ...
  int elevatorMax = 15;
  int? myDir;
  int? elevatorWaitingTime, elevatorWaitingTime_1;
  ...
  myClass_1 myclass_1 = myClass_1(elevatorFloor, myDir, myFloor);
  for (int i = 0; i < 100; i++) {
    myclass.elevator();
    elevatorWaitingTime = myclass.numberOfCases();
    myclass_1.elevator();
    elevatorWaitingTime_1 = myclass_1.numberOfCases();
    print(elevatorWaitingTime);
    print(elevatorWaitingTime_1);
    selectedTime = (elevatorWaitingTime! >= elevatorWaitingTime_1!
        ? elevatorWaitingTime
        : elevatorWaitingTime_1);
...
class myClass_1 {
  myClass_1(this.elevatorFloor, this.myDir, this.myFloor);
  List elevatorFloor;
  int myDir;
  int myFloor;
  int? Min;
